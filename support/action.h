...
/** This declares/implements a subset of KAction's API (notably we've left out
 * global shortcuts for now), which should make it easy to plug in KDE support
 * later on.
 */
class Action : public QAction {
   ...
   public:
    enum ShortcutType { ActiveShortcut = 0x01, DefaultShortcut = 0x02 };
    ...
    void setShortcut(const QShortcut& shortcut,
                     ShortcutTypes type = ShortcutTypes(ActiveShortcut |
                                                        DefaultShortcut));
