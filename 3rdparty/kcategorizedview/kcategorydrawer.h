 ...
 *
 * The category drawing is performed by this class. It also gives information
 * about the category height and margins.
 *
 */
class /*KITEMVIEWS_EXPORT*/ KCategoryDrawer : public QObject {
   ...
   public:
    ...
    /**
     * @return The category height for the category representated by index @p
     * index with style options @p option.
     */
   ...
   Q_SIGNALS:
    ...
    /**
     * Emit this signal on your subclass implementation to notify that something
     * happened. Usually this will be triggered when you have received an event,
     * and its position matched some "hot spot".
     *
     * You give this action the integer you want, and having connected this
     * signal to your code, the connected slot can perform the needed changes
     * (view, model, selection model, delegate...)
     */
   ...
   protected:
     ...
     *
     * @warning You explicitly have to determine whether the event has been
     * accepted or not. You have to call event->accept() or event->ignore() at
     * all possible case branches in your code.
     */
    virtual void mouseButtonPressed(const QModelIndex& index,
     ...
     * all possible case branches in your code.
     */
    virtual void mouseButtonReleased(const QModelIndex& index,
     ...
     * @param event The mouse event.
     */
    virtual void mouseMoved(const QModelIndex& index, const QRect& blockRect,
                            QMouseEvent* event);
     ...
     * all possible case branches in your code.
     */
    virtual void mouseButtonDoubleClicked(const QModelIndex& index,
                                          const QRect& blockRect,
                                          QMouseEvent* event);
...
{
public:
    KITEMVIEWS_DEPRECATED KCategoryDrawerV3(KCategorizedView *view) :
