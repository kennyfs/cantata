 ...
 *
 * An optical disc is a volume that can be inserted in CD-R*,DVD*,Blu-Ray,HD-DVD
 * drives.
 */
class SOLID_EXPORT OpticalDisc : public StorageVolume {
   ...
   public:
     ...
     * - DvdPlusRecordableDuallayer : A Digital Versatile Disc Recordable
     * Dual-Layer (DVD+R DL)
     * - DvdPlusRewritableDuallayer : A Digital Versatile Disc ReWritable
     * Dual-Layer (DVD+RW DL)
     ...
     * - HdDvdRecordable : A High Density Digital Versatile Disc Recordable (HD
     * DVD-R)
     * - HdDvdRewritable : A High Density Digital Versatile Disc ReWritable (HD
     * DVD-RW)
     */
    enum DiscType {
        UnknownDiscType = -1,
