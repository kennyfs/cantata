...
class SOLID_EXPORT DeviceInterface : public QObject {
   ...
   public:
    /**
     * This enum type defines the type of device interface that a Device can
     * have.
     *
    ...
    enum Type {
        Unknown = 0,
        GenericInterface = 1, /*Processor = 2, */
        Block = 3,
        StorageAccess = 4,
        StorageDrive = 5,
        OpticalDrive = 6,
     ...
     * A device interface is considered valid if the device it is referring is
     * available in the system.
     *
     * @return true if this device interface's device is available, false
     * otherwise
     */
    bool isValid() const;
    ...
    /**
     *
     * @return a description suitable to display in the UI of the device
     * interface type
     * @since 4.4
     */
   ...
   protected:
     ...
     *
     * @param dd the private d member. It will take care of deleting it upon
     * destruction.
