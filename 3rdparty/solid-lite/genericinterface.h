...
class SOLID_EXPORT GenericInterface : public DeviceInterface {
   ...
   public:
    /**
     * This enum type defines the type of change that can occur to a
     * GenericInterface property.
     *
   ...
   public:
    ...
    /**
     * Get the Solid::DeviceInterface::Type of the GenericInterface device
     * interface.
     *
   ...
   Q_SIGNALS:
     ...
     * (added/removed/modified), it's one of the type
