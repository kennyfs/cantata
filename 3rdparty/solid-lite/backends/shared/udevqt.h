...
class Device {
   public:
    ...
    // ### should this really be a QVariant? as far as udev knows, everything is
    // a string... see also Client::devicesByProperty
...
class Client : public QObject {
   ...
   public:
    ...
    DeviceList devicesByProperty(const QString& property,
    ...
    Device deviceBySubsystemAndName(const QString& subsystem,
                                    const QString& name);
