...
bool StorageAccess::isAccessible() const { return !m_logicalDisk.isNull(); }
...
bool StorageAccess::setup() {
    ...
    // if
    // (m_device->property("info.interfaces").toStringList().contains("org.freedesktop.Wmi.Device.Volume.Crypto"))
    // { return requestPassphrase();
    // } else if
    // (FstabHandling::isInFstab(m_device->property("block.device").toString()))
...
void Solid::Backends::Wmi::StorageAccess::slotProcessFinished(
...
bool StorageAccess::callWmiVolumeMount() {
    ...
    // QDBusMessage msg = QDBusMessage::createMethodCall("org.freedesktop.Wmi",
    // udi, "org.freedesktop.Wmi.Device.Volume", "Mount");
    // QStringList options;
    // QStringList wmiOptions =
...
bool StorageAccess::callWmiVolumeUnmount() {
    ...
    // QString udi = m_device->udi();
    // QDBusMessage msg = QDBusMessage::createMethodCall("org.freedesktop.Wmi",
    // udi, "org.freedesktop.Wmi.Device.Volume", "Unmount");
