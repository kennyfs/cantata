...
class PortableMediaPlayer : public DeviceInterface,
   ...
   private:
    /**
     * Return full absolute path to media-player-info .mpi file, based on
     * ID_MEDIA_PLAYER udev property. Does not check for existence. Returns
     * empty string in case no reasonable file path could be determined.
     */
