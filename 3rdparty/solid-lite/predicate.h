...
class SOLID_EXPORT Predicate {
   public:
    /**
     * The comparison operator which can be used for matching within the
     * predicate.
     *
     * - Equals, the property and the value will match for strict equality
     * - Mask, the property and the value will match if the bitmasking is not
     * null
     */
     ...
     *
     * - PropertyCheck, the predicate contains a comparison that needs to be
     * matched using a ComparisonOperator
     * - Conjunction, the two contained predicates need to be true for this
     * predicate to be true
     * - Disjunction, either of the two contained predicates may be true for
     ...
     * @param compOperator the operator to apply between the property and the
     * value when matching
     */
    Predicate(const DeviceInterface::Type& ifaceType, const QString& property,
              const QVariant& value, ComparisonOperator compOperator = Equals);
     ...
     * value when matching
     */
    Predicate(const QString& ifaceName, const QString& property,
              const QVariant& value, ComparisonOperator compOperator = Equals);

    /**
     * Constructs a predicate matching devices being of a particular device
     * interface
     *
     ...
     *
     * @param other the second operand
     * @return assigns to 'this' a new 'and' predicate having 'this' and 'other'
     * as operands
     */
    Predicate& operator&=(const Predicate& other);
     ...
     *
     * @param other the second operand
     * @return assigns to 'this' a new 'or' predicate having 'this' and 'other'
     * as operands
     */
    Predicate& operator|=(const Predicate& other);
    ...
    /**
     * Retrieves the property name used when retrieving the value to compare
     * against
     *
    ...
    /**
     * Retrieves the value used when comparing a devices property to see if it
