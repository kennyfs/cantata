...
class StorageAccess : virtual public DeviceInterface {
   ...
   protected:
     ...
     * @param udi the UDI of the volume
     */
    virtual void setupDone(Solid::ErrorType error, QVariant resultData,
                           const QString& udi) = 0;
     ...
     * @param udi the UDI of the volume
     */
    virtual void teardownDone(Solid::ErrorType error, QVariant resultData,
                              const QString& udi) = 0;
...
Q_DECLARE_INTERFACE(Solid::Ifaces::StorageAccess,
