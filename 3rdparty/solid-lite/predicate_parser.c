...
static const yytype_uint8 yytranslate[] = {
    ...
    2,  2,  2, 2, 2, 2, 2, 2, 2,  2, 2,  2, 2,  2,  2, 2, 2, 2, 2, 2, 2, 18, 2,
    ...
    2,  2,  2, 2, 2, 2, 2, 2, 16, 2, 17, 2, 2,  2,  2, 2, 2, 2, 2, 2, 2, 2,  2,
...
/* YYPRHS[YYN] -- Index of the first RHS symbol of rule number YYN in
   YYRHS.  */
static const yytype_uint8 yyprhs[] = {0,  0,  3,  5,  9,  13, 19, 25, 28, 32,
                                      36, 38, 40, 42, 44, 46, 50, 51, 53};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] = {
    20, 0,  -1, 21, -1, 13, 22, 14, -1, 13, 23, 14, -1, 10, 15, 10, 3,  24, -1,
    10, 15, 10, 4,  24, -1, 7,  10, -1, 20, 6,  20, -1, 20, 5,  20, -1, 9,  -1,
    8,  -1, 11, -1, 12, -1, 25, -1, 16, 26, 17, -1, -1, 9,  -1, 9,  18, 26, -1};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] = {0,  60, 60, 61, 62, 64, 65, 66, 68, 70,
...
static const yytype_uint16 yytoknum[] = {0,   256, 257, 258, 259, 260, 261,
                                         262, 263, 264, 265, 266, 267, 91,
                                         93,  46,  123, 125, 44};
#endif

/* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] = {0,  19, 20, 20, 20, 21, 21, 21, 22, 23,
                                    24, 24, 24, 24, 24, 25, 26, 26, 26};

/* YYR2[YYN] -- Number of symbols composing right hand side of rule YYN.  */
static const yytype_uint8 yyr2[] = {0, 2, 1, 3, 3, 5, 5, 2, 3, 3,
                                    1, 1, 1, 1, 1, 3, 0, 1, 3};
...
static const yytype_uint8 yydefact[] = {
    0, 0, 0, 0, 0,  2,  7,  0,  0,  0, 0,  1, 0,  0, 0,  3,  4,
    0, 0, 9, 8, 11, 10, 12, 13, 16, 5, 14, 6, 17, 0, 16, 15, 18};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] = {-1, 4, 5, 9, 10, 26, 27, 30};

/* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
   STATE-NUM.  */
#define YYPACT_NINF -13
static const yytype_int8 yypact[] = {
    5,   -2, -12, 5,   16,  -13, -13, 7,   1,   6,   8,   -13,
    10,  5,  5,   -13, -13, -7,  -7,  -13, -13, -13, -13, -13,
    -13, 12, -13, -13, -13, 9,   2,   12,  -13, -13};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] = {-13, -3, -13, -13, -13, 11, -13, -8};
...
static const yytype_uint8 yytable[] = {8,  21, 22, 7,  23, 24, 13, 14, 6, 25,
                                       19, 20, 1,  17, 18, 2,  11, 12, 3, 32,
                                       15, 29, 16, 33, 0,  0,  0,  31, 0, 28};

static const yytype_int8 yycheck[] = {3,  8,  9,  15, 11, 12, 5,  6,  10, 16,
...
static const yytype_uint8 yystos[] = {
    0, 7, 10, 13, 20, 21, 10, 15, 20, 22, 23, 0,  10, 5,  6,  14, 14,
    3, 4, 20, 20, 8,  9,  11, 12, 16, 24, 25, 24, 9,  26, 18, 17, 26};
...
#line 60 "predicate_parser.y"
        {
            PredicateParse_setResult((yyvsp[(1) - (1)].ptr));
...
#line 61 "predicate_parser.y"
        {
            PredicateParse_setResult((yyvsp[(2) - (3)].ptr));
...
#line 64 "predicate_parser.y"
        {
            (yyval.ptr) = PredicateParse_newAtom((yyvsp[(1) - (5)].name),
                                                 (yyvsp[(3) - (5)].name),
                                                 (yyvsp[(5) - (5)].ptr));
            ;
        } break;
...
#line 65 "predicate_parser.y"
        {
            (yyval.ptr) = PredicateParse_newMaskAtom((yyvsp[(1) - (5)].name),
                                                     (yyvsp[(3) - (5)].name),
                                                     (yyvsp[(5) - (5)].ptr));
            ;
        } break;
...
#line 68 "predicate_parser.y"
        {
            (yyval.ptr) = PredicateParse_newOr((yyvsp[(1) - (3)].ptr),
                                               (yyvsp[(3) - (3)].ptr));
            ;
        } break;
...
#line 70 "predicate_parser.y"
        {
            (yyval.ptr) = PredicateParse_newAnd((yyvsp[(1) - (3)].ptr),
                                                (yyvsp[(3) - (3)].ptr));
            ;
        } break;
...
#line 72 "predicate_parser.y"
        {
            (yyval.ptr) =
                PredicateParse_newStringValue((yyvsp[(1) - (1)].name));
            ;
        } break;
...
#line 75 "predicate_parser.y"
        {
            (yyval.ptr) =
                PredicateParse_newDoubleValue((yyvsp[(1) - (1)].vald));
            ;
        } break;
...
#line 81 "predicate_parser.y"
        {
            (yyval.ptr) =
                PredicateParse_newStringListValue((yyvsp[(1) - (1)].ptr));
            ;
        } break;
...
#line 82 "predicate_parser.y"
        {
            (yyval.ptr) = PredicateParse_appendStringListValue(
                (yyvsp[(1) - (3)].name), (yyvsp[(3) - (3)].ptr));
            ;
        } break;
