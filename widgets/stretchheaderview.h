...
class StretchHeaderView : public QHeaderView {
   ...
   public:
    ...
    // Sets the width of the given column and resizes other columns
    // appropriately. width is the proportion of the entire width from 0.0
    // to 1.0.
   ...
   private:
    // If the width of the given column is less than a sensible threshold,
    // resize it to make it bigger.  Workaround for a QHeaderView oddity that
    // means a column can be visible but with a width of 0.
