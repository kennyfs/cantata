...
class MusicLibraryItemRoot : public MusicLibraryItemContainer {
   public:
    ...
    void toXML(const QString& filename,
               MusicLibraryProgressMonitor* prog = nullptr) const;
    void toXML(QXmlStreamWriter& writer,
               MusicLibraryProgressMonitor* prog = nullptr) const;
    bool fromXML(const QString& filename, const QString& baseFolder = QString(),
                 MusicLibraryProgressMonitor* prog = nullptr,
                 MusicLibraryErrorMonitor* em = nullptr);
    bool fromXML(QXmlStreamReader& reader,
                 const QString& baseFolder = QString(),
                 MusicLibraryProgressMonitor* prog = nullptr,
                 MusicLibraryErrorMonitor* em = nullptr);
   ...
   protected:
    bool supportsAlbumArtist;  // TODO: ALBUMARTIST: Remove when libMPT supports
                               // album artist!
    bool isFlat;
